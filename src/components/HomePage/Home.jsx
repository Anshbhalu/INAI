...
const Home = () => {
  const homeHeroData = {
    ...
    buttons: [
      { text: "Apply for Internship", link: "/contact", className: "btn-primary-hero" },
    ]
  };
  ...
  return (
    <div className="home">
      <Hero
        ...
        title={<>Best AI Company Delivering<span className="highlight-text">Future-Ready Solutions & Career</span>Defining AI/ML Internship</>}
