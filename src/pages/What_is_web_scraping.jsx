    ...
    <div className="blog-layout">
      ...
      <div className="blog-detail-page" style={{ marginBottom: '100px' }}>
        ...
        <div className="blog-detail-content">
          ...
          <p>At INAI Worlds, our AI/ML Internship in Surat offers hands-on training where beginners learn web scraping by working on real-world machine learning projects.</p>
