  ...
  return (
    <>
      ...
      <div className="service-detail-page model-training-page">
        ...
        <div className="features-cards why-web">
          <h2>Want to get hands-on with real-world AI model development? Explore our AI/ML internship in Surat that’s designed around production-level AI training.</h2>
        </div>
        ...
        <div className="cta-full-bg">
          <div className="cta-full-content">
            ...
            <div className="cta-btn-row">
              <a href="#start" className="cta-btn">Start Your AI Journey</a>
            </div>
          </div>
        </div>
